...
var HttpsErrorImpl = /** @class */ (function (_super) {
    index_esm.__extends(HttpsErrorImpl, _super);
...
function registerFunctions(instance) {
    ...
    instance.INTERNAL.registerComponent(new index_esm.Component(FUNCTIONS_TYPE, factory, "PUBLIC" /* PUBLIC */)
 ...
 * limitations under the License.
 */
registerFunctions(index_esm.firebase);
index_esm.firebase.registerVersion(name, version);
