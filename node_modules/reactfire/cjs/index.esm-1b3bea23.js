...
var ERROR_DESCRIPTION_MAP = (_a = {},
    ...
    _a);
var ERROR_FACTORY = new index_esm.ErrorFactory('remoteconfig' /* service */, 'Remote Config' /* service name */, ERROR_DESCRIPTION_MAP);
// Note how this is like typeof/instanceof, but for ErrorCode.
function hasErrorCode(e, errorCode) {
    return e instanceof index_esm.FirebaseError && e.code.indexOf(errorCode) !== -1;
}
            ...
            return index_esm.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        setTimeout(function () { return index_esm.__awaiter(_this, void 0, void 0, function () {
                            return index_esm.__generator(this, function (_a) {
...
function getAllKeys(obj1, obj2) {
    if (obj1 === void 0) { obj1 = {}; }
    if (obj2 === void 0) { obj2 = {}; }
    return Object.keys(index_esm.__assign(index_esm.__assign({}, obj1), obj2));
}
...
function isRetriableError(e) {
    if (!(e instanceof index_esm.FirebaseError)) {
        return false;
    }
...
function registerRemoteConfig(firebaseInstance) {
    firebaseInstance.INTERNAL.registerComponent(new index_esm.Component('remoteConfig', remoteConfigFactory, "PUBLIC" /* PUBLIC */).setMultipleInstances(true));
...
registerRemoteConfig(index_esm.firebase);
