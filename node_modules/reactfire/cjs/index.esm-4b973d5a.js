...
function processQueue(timeOffset) {
    setTimeout(function () {
        ...
        var staged = index_esm.__spreadArrays(queue);
        queue = [];
        /* eslint-disable camelcase */
        ...
        fetch(SettingsService.getInstance().logEndPointUrl, {
             ...
             */
            queue = index_esm.__spreadArrays(staged, queue);
            remainingTries--;
...
function addToQueue(evt) {
    ...
    queue = index_esm.__spreadArrays(queue, [evt]);
}
...
var Trace = /** @class */ (function () {
    ...
    Trace.prototype.record = function (startTime, duration, options) {
        ...
        if (options && options.attributes) {
            this.customAttributes = index_esm.__assign({}, options.attributes);
        }
    ...
    Trace.prototype.getAttributes = function () {
        return index_esm.__assign({}, this.customAttributes);
    };
...
function registerPerformance(instance) {
    ...
    instance.INTERNAL.registerComponent(new index_esm.Component('performance', function (container) {
        /* Dependencies */
...
registerPerformance(index_esm.firebase);
