...
var Reference = /** @class */ (function () {
    ...
    Reference.prototype.listAllHelper = function (accumulator, pageToken) {
        return index_esm.__awaiter(this, void 0, void 0, function () {
            var opt, nextPage;
            var _a, _b;
            return index_esm.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        opt = {
...
function start(f, callback, timeout) {
    ...
    function handler(success) {
        ...
        if (success) {
            triggerCallback.call.apply(triggerCallback, index_esm.__spreadArrays([null, success], args));
            return;
        }
...
function addVersionHeader_(headers) {
    var version = typeof index_esm.firebase !== 'undefined' ? index_esm.firebase.SDK_VERSION : 'AppManager';
...
function registerStorage(instance) {
    ...
    instance.INTERNAL.registerComponent(new index_esm.Component(STORAGE_TYPE, factory, "PUBLIC" /* PUBLIC */)
        .setServiceProps(namespaceExports)
        .setMultipleInstances(true));
    instance.registerVersion(name, version);
}
registerStorage(index_esm.firebase);
