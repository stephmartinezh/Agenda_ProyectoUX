...
var Provider = /** @class */ (function () {
    ...
    Provider.prototype.getImmediate = function (options) {
        var _a = exports.__assign({ identifier: DEFAULT_ENTRY_NAME, optional: false }, options), identifier = _a.identifier, optional = _a.optional;
        // if multipleInstances is not supported, use the default name
        var normalizedIdentifier = this.normalizeInstanceIdentifier(identifier);
        try {
            var instance = this.getOrInitializeService(normalizedIdentifier);
...
function createFirebaseNamespace() {
    ...
    namespace.INTERNAL = exports.__assign(exports.__assign({}, namespace.INTERNAL), { createFirebaseNamespace: createFirebaseNamespace,
...
exports.stringToByteArray$1 = stringToByteArray$1;
