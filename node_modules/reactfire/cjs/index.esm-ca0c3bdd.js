...
function logEvent(gtagFunction, analyticsId, eventName, eventParams, options) {
    ...
    if (!options || !options.global) {
        params = index_esm.__assign(index_esm.__assign({}, eventParams), { 'send_to': analyticsId });
    }
...
var ERRORS = (_a = {},
    ...
    _a);
var ERROR_FACTORY = new index_esm.ErrorFactory('analytics', 'Analytics', ERRORS);
...
function registerAnalytics(instance) {
    instance.INTERNAL.registerComponent(new index_esm.Component(ANALYTICS_TYPE, function (container) {
    ...
    instance.INTERNAL.registerComponent(new index_esm.Component('analytics-internal', internalFactory, "PRIVATE" /* PRIVATE */));
...
registerAnalytics(index_esm.firebase);
