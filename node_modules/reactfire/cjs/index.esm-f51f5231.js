...
var ERROR_MAP = (_a = {},
    ...
    _a);
var errorFactory = new index_esm.ErrorFactory('messaging', 'Messaging', ERROR_MAP);
...
function toBase64(arrayBuffer) {
    ...
    return btoa(String.fromCharCode.apply(String, index_esm.__spread(uint8Version)));
}
...
function getHeaders(_a) {
    ...
    return index_esm.__awaiter(this, void 0, void 0, function () {
        var authToken;
        return index_esm.__generator(this, function (_b) {
            switch (_b.label) {
...
var TokenDetailsModel = /** @class */ (function (_super) {
    index_esm.__extends(TokenDetailsModel, _super);
            ...
            case 2: {
                ...
                cursorRequest_1.onsuccess = function () {
                    ...
                    if (cursor) {
                        ...
                        var newValue = index_esm.__assign({}, value);
                        if (!value.createTime) {
...
var VapidDetailsModel = /** @class */ (function (_super) {
    index_esm.__extends(VapidDetailsModel, _super);
...
var SwController = /** @class */ (function (_super) {
    index_esm.__extends(SwController, _super);
    ...
    SwController.prototype.getNotificationData_ = function (msgPayload) {
        ...
        var notificationInformation = index_esm.__assign({}, msgPayload.notification);
        // Put the message payload under FCM_MSG name so we can identify the
        // notification as being an FCM notification vs a notification from
        // somewhere else (i.e. normal web push or developer generated
        // notification).
        notificationInformation.data = index_esm.__assign(index_esm.__assign({}, msgPayload.notification.data), (_a = {}, _a[FCM_MSG] = msgPayload, _a));
...
var WindowController = /** @class */ (function (_super) {
    index_esm.__extends(WindowController, _super);
    /**
    ...
    function WindowController(services) {
        ...
        _this.onMessageInternal = index_esm.createSubscribe(function (observer) {
            _this.messageObserver = observer;
        });
        _this.onTokenRefreshInternal = index_esm.createSubscribe(function (observer) {
    ...
    WindowController.prototype.setupSWMessageListener_ = function () {
        var _this = this;
        navigator.serviceWorker.addEventListener('message', function (event) { return index_esm.__awaiter(_this, void 0, void 0, function () {
...
function registerMessaging(instance) {
    ...
    instance.INTERNAL.registerComponent(new index_esm.Component(messagingName, factoryMethod, "PUBLIC" /* PUBLIC */).setServiceProps(namespaceExports));
    instance.registerVersion(name, version);
}
registerMessaging(index_esm.firebase);
